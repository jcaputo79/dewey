  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved metric as @metric" do
        ...
        post :create, {:metric => { "name" => "invalid value" }}, valid_session
        assigns(:metric).should be_a_new(Metric)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested metric" do
        ...
        Metric.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => metric.to_param, :metric => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the metric as @metric" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Metric.any_instance.stub(:save).and_return(false)
        put :update, {:id => metric.to_param, :metric => { "name" => "invalid value" }}, valid_session
        assigns(:metric).should eq(metric)
      end
